import 'package:bitconcept/model/user.dart';
import 'package:bitconcept/bitconcept.dart';
import 'package:aqueduct_test/aqueduct_test.dart';

export 'package:bitconcept/bitconcept.dart';
export 'package:aqueduct_test/aqueduct_test.dart';
export 'package:test/test.dart';
export 'package:aqueduct/aqueduct.dart';

/// A testing harness for bitconcept.
///
...
///         }
///
class Harness extends TestHarness<BitconceptChannel> with TestHarnessAuthMixin<BitconceptChannel>, TestHarnessORMMixin {
  @override
